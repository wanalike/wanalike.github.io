  ...
  const projectsHtml = `
    <section class="section section-page projects-page fade-in">
      ...
      <section class="project-showcase reveal-block is-visible">
        <a href="https://wanachess.wanalike.com" target="_blank" class="project-feature project-chess">
        ...
        <a href="https://fm.wanalike.com" target="_blank" class="project-feature project-radio">
        ...
        <a href="https://board.wanalike.com" target="_blank" class="project-feature project-board">
